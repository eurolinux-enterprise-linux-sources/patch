...
# when adding a new file (bug #550319).
...
* Fri Aug  6 2010 Tim Waugh <twaugh@redhat.com> 2.6-5
- Fixed selinux patch (bug #618215).

* Tue Jul 27 2010 Tim Waugh <twaugh@redhat.com> 2.6-4
- Fixed argument type for --get (bug #618216).

* Wed Mar  3 2010 Tim Waugh <twaugh@redhat.com> 2.6-3
